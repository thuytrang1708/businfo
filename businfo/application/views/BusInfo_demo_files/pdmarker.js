...
icon.image = "tfl-bus-map/img/stop-active-2.png";
...
function initTooltip(theObj) {
	...
	//b.setAttribute('class', 'markerTooltipPopup');
	//b.setAttribute('style', 'z-index: -90000;');
	b.innerHTML = theObj.tooltipText;

	// append to body for size calculations
	var c = document.body;
	//var d = document.getElementById("pdmarkerwork");
	var d = document.getElementById("busesRightCol_MapHolder");
	if (d)
		c = d;
	c.appendChild(b);
	b.style.position = "absolute";
	b.style.bottom = "5px";
	b.style.left = "5px";
	//b.style.zIndex = 1;	//z-index = -360 -> 360 only
