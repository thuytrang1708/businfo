			...
			<div id="page:main-container">
				...
				<div class="dashboard-container">
					<div>
						<ul id="mainStepNav" class="fiveStep">
							...
							<li class="lastDone"><a title=""><em>Bước 2: Xác Định Lộ Trình Đi</em><span></span></a></li>
							<li class="current"><a title=""><em>Bước 3: Trạm Bus Lộ Trình Đi</em><span></span></a></li>
				...
				<div class="columns ">
					<div id="page:left" class="side-col">
						<h3>Các Trạm Bus Lộ Trình Bus Đi Tuyến <?php echo $route;?></h3>
							...
							<div id="product_info_tabs_group_4_content" style="">
								<div class="entry-edit">
									<div class="entry-edit-head">
										<h4 class="icon-head head-edit-form fieldset-legend">Trạm Bus Của Lộ Trình Đi Tuyến Bus</h4>
