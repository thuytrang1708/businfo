...
<!-- Global head start -->
	...
	<script type="text/javascript" src="http://localhost/BusInfo/public/BusInfo/js/jquery-1.js"></script>
...
<!-- JS is disabled -->
		...
		<script src="http://localhost/BusInfo/public/BusInfo/js/jquery00.js" type="text/javascript"></script>
		<script src="http://localhost/BusInfo/public/BusInfo/js/jquery01.js" type="text/javascript"></script>
		<script src="http://localhost/BusInfo/public/BusInfo/js/markerma.js" type="text/javascript"></script>


		<!--[if IE 6]>
			<link type="text/css" rel="stylesheet" href="http://localhost/BusInfo/public/BusInfo/css/tfl-bus-mapIE6.css" media="all" />
		<![endif]-->		
		<link href="http://localhost/BusInfo/public/BusInfo/css/colorbox.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="http://localhost/BusInfo/public/BusInfo/js/buttons0.js"></script>
				...
				<div id="busesLeftCol_Routes">
					<div id="mm-LHP-NoResults">
						<div class="mm-LHP-NoResults_heading" >
							<h3>
								<img src="http://localhost/BusInfo/public/BusInfo/images/exclamat.png" class="no_resultsIcon" alt="" />
								No results found</h3>
						</div>
					</div>
					...
					<div id="mm-LHP-AppErrorMsg" style="display: none;">
						<div class="mm-LHP-NoResults_heading">
							<h3>
								<img src="http://localhost/BusInfo/public/BusInfo/images/exclamat.png" class="no_resultsIcon" alt="" /></h3>
						</div>
						<div>
