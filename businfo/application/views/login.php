...
<head id="ctl00_Head1">
	...
	<link type="text/css" rel="stylesheet" href="http://localhost/businfo/public/css/MainStyle.css" media="all" />
	<link type="text/css" rel="stylesheet" href="http://localhost/businfo/public/css/Login.css" media="all" />
	
	<script type="text/javascript" src="http://localhost/businfo/public/js/googlemap.js"></script>
	<script src="http://localhost/businfo/public/js/jquery00.js" type="text/javascript"></script>
    <script src="http://localhost/businfo/public/js/jquery01.js" type="text/javascript"></script>
    <script src="demo_files/markerma.js" type="text/javascript"></script>
    <script type="text/javascript" src="http://localhost/businfo/public/js/jquery-1.js"></script>
    <script type="text/javascript" src="http://localhost/businfo/public/js/TabMenu.js"></script>
			...
			<!--  End Tab Header -->
	         <div id="login">
				<div id="line2">
					...
					<a id="Login" class="line2login" href="home/login">Đăng Nhập</a>
				</div>
			</div>
        </div>
            ...
            <form method="post" action="" id="loginForm">
                <div class="login-form">
                    ...
                    <div class="form-buttons">
                        ...
                        <!-- <input type="submit" class="form-button" value="Login" title="Login" onClick="parent.location='http://localhost/businfo/'">
                        -->
                        <input type=button class="form-button" onClick="parent.location='<?php echo base_url()?>home/ad_home'" value="Đăng Nhập">
                    </div>
                </div>
            </form>
