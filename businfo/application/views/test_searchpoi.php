...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <body onload="initialize();">
    ...
    Box within at least <input type="text" id="distance" value="0.5" size="2">miles
   of the route from <input type="text" id="from" value="10.770811,106.698455"/>
    to <input type="text" id="to" value="10.8758716797286,106.800933480263"/>
    <input type="submit" onclick="route()"/>
    <input type="submit" onclick="searchpoi()"/>
  </body>
</html>
